...
public class French extends ActionBarActivity {
    ...
    private static final String UNZIP_FRA = Environment.getExternalStorageDirectory() + "/Download/unzipped_fra/";
    private static final String ZIP_FILE_FRA = Environment.getExternalStorageDirectory() +"/Download/633_amelioration_efficacite_energetique_vehicules_legers_1990_2010.zip";
    private static final String MAP_FRA = UNZIP_FRA + "amelioration_efficacite_energetique_vehicules_legers_1990_2010_carte.jpg";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView title = (TextView)findViewById(R.id.title_fra);
        TextView notes = (TextView)findViewById(R.id.notes_fra);
        title.setText(TITLE_FRA);
        notes.setText(NOTES_FRA);
        ...
        if (id == R.id.action_eng) {
            ...
            builder.setNegativeButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Intent intent = new Intent(French.this, English.class);
    ...
    public void Unzip (View v) {
        ...
        File unzip = new File(UNZIP_FRA);
        File zip = new File(ZIP_FILE_FRA);
        if (zip.exists()) {
            if (!unzip.isDirectory()) {
                unZip d = new unZip(ZIP_FILE_FRA, UNZIP_FRA);
                d.unzip();
            } else {
